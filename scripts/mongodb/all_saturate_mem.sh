#./start_experiment.sh 5 workloads 300 1 azure leader swapoff mem
#./start_experiment.sh 5 workloads 300 2 azure leader swapoff mem
#./start_experiment.sh 5 workloads 300 5 azure leader swapoff mem
#./start_experiment.sh 5 workloads 300 6 azure leader swapon mem

#./start_experiment.sh 5 workloads 300 1 azure noslow swapoff mem
